...
# NOTE: implementation taken from https://github.com/kuan-wang/pytorch-mobilenet-v3
# and modified to fit the needs of FaceNet.
...
def mobilenetv3(pretrained=None, **kwargs):
